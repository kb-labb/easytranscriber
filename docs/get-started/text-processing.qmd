...
A more in-depth guide on custom tokenization will be available in the [`easyaligner`](https://kb-labb.github.io/easyaligner/) documentation, with a focus on aligning ground truth texts with longer audio segments.